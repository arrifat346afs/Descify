    ...
    <Dialog {...props}>
      ...
      <DialogPortal>
        <DialogPrimitive.Content
          ...
          className={cn(
            "fixed top-1/2 left-1/2 z-50 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-2rem)] max-w-[450px] min-w-[200px] overflow-hidden rounded-xl p-0 duration-100 outline-none data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
            className
          )}
        >
          <Command>
